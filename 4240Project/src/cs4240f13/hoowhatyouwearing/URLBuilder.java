...
public class URLBuilder {
	...
	public static String buildForecastURL(String city, String tempUnits) throws UnsupportedEncodingException{
		return "http://api.openweathermap.org/data/2.5/forecast/daily?q=" + URLEncoder.encode(city,"utf-8") + "&mode="+ DATA_FORMAT + "&units=" + tempUnits + "&cnt=" + NUM_DAYS_FORECAST;
	}
	
	public static String buildTodayURL(String city, String tempUnits) throws UnsupportedEncodingException{
		return "http://api.openweathermap.org/data/2.5/weather?q=" + URLEncoder.encode(city,"utf-8") + "&mode="+ DATA_FORMAT + "&units=" + tempUnits;
	}
